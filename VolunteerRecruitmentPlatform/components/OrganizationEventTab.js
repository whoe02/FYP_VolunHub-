...
import organizationEventTabList from '../components/OrganizationEventTabList';
...
function HomeTab({onTabChanged}) {
    ...
    const handleSelectTab = (index) => {
        ...
        onTabChanged(organizationEventTabList[index].slug);
    };
    ...
    return (
        <View>
            ...
            <ScrollView ref={scrollRef} horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.itemWrapper}>
                {organizationEventTabList.map((item, index) => (
